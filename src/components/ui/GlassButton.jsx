...
const GlassButton = React.forwardRef(function GlassButton(
  ...
  const baseStyle = {
    ...
    transition: 'transform 0.25s cubic-bezier(0.16, 1, 0.3, 1), filter 0.25s cubic-bezier(0.16, 1, 0.3, 1), background-color 0.25s cubic-bezier(0.16, 1, 0.3, 1), border-color 0.25s cubic-bezier(0.16, 1, 0.3, 1)',
    filter: 'brightness(1)',
    userSelect: 'none',
